...
LV_FONT_DECLARE(font_roboto_20_4);
...
private:
    ...
    void InitializePowerSaveTimer() {
        ...
        power_save_timer_->OnExitSleepMode([this]() {
            // GetDisplay()->SetPowerSaveMode(false); // Helper removed as it's not in Display interface
...
private:
    void RegisterRadioTools() {
        // Radio tools removed as RadioPlayer is not available in v1.6.6
    }
};
