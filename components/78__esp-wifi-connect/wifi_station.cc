...
void WifiStation::Start() {
    ...
    // If already initialized, this might return ESP_ERR_INVALID_STATE, which we can ignore or handle if needed.
    // However, since we determined it was missing, we expect ESP_OK.
